...
toy.func @convert_add_to_mid_vec_two_dim(%arg0: tensor<2x3xf64>, %arg1: tensor<2x3xf64>) {
    ...
    // CHECK: %c0 = arith.constant 0 : index
    // CHECK: %0 = vector.load %arg0[%c0, %c0] : memref<2x3xf64>, vector<2x3xf64>
    // CHECK: %1 = vector.load %arg1[%c0, %c0] : memref<2x3xf64>, vector<2x3xf64>
    // CHECK: %2 = arith.addf %0, %1 : vector<2x3xf64>
    // CHECK: vector.store %2, %alloc[%c0, %c0] : memref<2x3xf64>, vector<2x3xf64>
...
toy.func @convert_mul_to_mid_vec_two_dim(%arg0: tensor<2x3xf64>, %arg1: tensor<2x3xf64>) {
    ...
    // CHECK: %0 = vector.load %arg0[%c0, %c0] : memref<2x3xf64>, vector<2x3xf64>
    // CHECK: %1 = vector.load %arg1[%c0, %c0] : memref<2x3xf64>, vector<2x3xf64>
    // CHECK: %2 = arith.mulf %0, %1 : vector<2x3xf64>
    // CHECK: vector.store %2, %alloc[%c0, %c0] : memref<2x3xf64>, vector<2x3xf64>
    // CHECK: memref.dealloc %alloc : memref<2x3xf64>
    // CHECK: return
}
